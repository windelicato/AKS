...
int main(int argc, const char *argv[])
{
	...
	log_message("/home/sunn/bin/AKS/log/log.txt", test_message);
	*/
	...
	*/
	...
	l->scale = calloc(100, sizeof(struct scale));

	read_configuration("/home/sunn/bin/AKS/config.txt", l);
	int i;
	...
	write_configuration("/home/sunn/bin/AKS/config.txt", l);
